...
func _on_Chair_start_interaction():
	...
	$Chair/Interaction/SittingSprite.texture = load("res://assets/sprites/chairRemote.png")
	yield(get_tree().create_timer(2), "timeout")
	$Chair/Interaction/Television.show()
	$Chair/Interaction/SittingSprite.texture = load("res://assets/sprites/chairSit.png")
	...
	yield(get_tree().create_timer(2), "timeout")
	$Chair/Interaction/SittingSprite.texture = load("res://assets/sprites/chairSleep.png")
	$Chair/Interaction/Television.texture = load("res://assets/sprites/tvShine.png")
